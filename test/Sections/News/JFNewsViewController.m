...
@interface JFNewsViewController () <UICollectionViewDelegate, UICollectionViewDataSource>
/** 频道数据模型 */
...
@implementation JFNewsViewController
