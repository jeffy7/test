//
//  JFSDCycleViewController.m
//  test
//
//  Created by je_ffy on 2016/10/19.
...
@interface JFSDCycleViewController () <SDCycleScrollViewDelegate>

@end

@implementation JFSDCycleViewController
